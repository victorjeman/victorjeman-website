...
export const LandingHero: React.FC = () => {
  const scrollIntoView = () => {
    const landingProjectsIntro: Element | null = document.querySelector(
      '.js-landing-projects-intro',
    );

    if (landingProjectsIntro) {
      landingProjectsIntro.scrollIntoView({ behavior: 'smooth' });
    }
  };
    ...
    <section className="c-landing-hero">
      <div className="c-landing-hero__container  [ c-container ]">
        <div className="c-landing-hero__info">
          ...
          <div className="c-landing-hero__explore" onClick={scrollIntoView}>
            <ButtonExplore modifier={ISizeModifier.medium}>Explore</ButtonExplore>
          </div>
        </div>
