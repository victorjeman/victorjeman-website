...
export default function TermsPage({ homeworks }: IHomeworks): React.ReactNode {
    ...
    <PageLayout>
      ...
      <section className="c-faq">
        ...
        <Container type={ISizeModifier.small}>
          <h2>Welcome to VicorJeman!</h2>

          <p>
            These terms and conditions outline the rules and regulations for the use of
            VictorJeman's Website, located at victorjeman.com.
          </p>

          <p>
            By accessing this website we assume you accept these terms and conditions. Do not
            continue to use VicorJeman if you do not agree to take all of the terms and conditions
            stated on this page.
          </p>
          ...
          <p>
            We employ the use of cookies. By accessing VicorJeman, you agreed to use cookies in
            agreement with the VictorJeman's Privacy Policy.{' '}
          </p>
          ...
          <p>
            Unless otherwise stated, VictorJeman and/or its licensors own the intellectual property
            rights for all material on VicorJeman. All intellectual property rights are reserved.
            You may access this from VicorJeman for your own personal use subjected to restrictions
            set in these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from VicorJeman</li>
            <li>Sell, rent or sub-license material from VicorJeman</li>
            <li>Reproduce, duplicate or copy material from VicorJeman</li>
            <li>Redistribute content from VicorJeman</li>
          </ul>
          ...
          <p>
            ...
            information in certain areas of the website. VictorJeman does not filter, edit, publish
            or review Comments prior to their presence on the website. Comments do not reflect the
            views and opinions of VictorJeman,its agents and/or affiliates. Comments reflect the
            views and opinions of the person who post their views and opinions. To the extent
            permitted by applicable laws, VictorJeman shall not be liable for the Comments or for
          ...
          <p>
            VictorJeman reserves the right to monitor all Comments and to remove any Comments which
          ...
          <p>
            You hereby grant VictorJeman a non-exclusive license to use, reproduce, edit and
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of VictorJeman; and (d) the link is
          ...
          <p>
            ...
            linking to our website, you must inform us by sending an e-mail to VictorJeman. Please
          ...
          <p>
            No use of VictorJeman's logo or other artwork will be allowed for linking absent a
