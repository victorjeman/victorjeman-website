...
export default function TermsPage(): React.ReactNode {
  ...
  return (
    <PageLayout>
      ...
      <section className="c-privacy">
        <PageIntro pageTitle={pageTitle} />

        <Container type={ISizeModifier.small}>
          <h2>Privacy Policy for VictorJeman</h2>

          <p>
            At VictorJeman, accessible from victorjeman.com, one of our main priorities is the
            privacy of our visitors. This Privacy Policy document contains types of information that
            is collected and recorded by VictorJeman and how we use it.
          </p>
          ...
          <p>
            ...
            VictorJeman. This policy is not applicable to any information collected offline or via
          ...
          <p>
            VictorJeman follows a standard procedure of using log files. These files log visitors
          ...
          <p>
            Like any other website, VictorJeman uses 'cookies'. These cookies are used to store
          ...
          <p>
            ...
            VictorJeman, which are sent directly to users' browser. They automatically receive your
          ...
          <p>
            Note that VictorJeman has no access to or control over these cookies that are used by
          ...
          <p>
            VictorJeman's Privacy Policy does not apply to other advertisers or websites. Thus, we
          ...
          <p>
            VictorJeman does not knowingly collect any Personal Identifiable Information from
